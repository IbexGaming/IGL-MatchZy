...
namespace MatchZy
{
    public partial class MatchZy
    {
        ...
        public FakeConVar<string> techPausePermission = new(
            "matchzy_tech_pause_flag",
            "Flag required to use tech pause",
            ""
        );
        ...
        public FakeConVar<bool> showCreditsOnMatchStart = new(
        ...
        public void MatchZyDemoRecordingEnabled(CCSPlayerController? player, CommandInfo command)
        {
            ...
            isDemoRecordingEnabled = bool.TryParse(args, out bool isDemoRecordingEnabledValue)
                ? isDemoRecordingEnabledValue
                : args != "0" && isDemoRecordingEnabled;
        }
        ...
        public void MatchZyDemoUploadURL(CCSPlayerController? player, CommandInfo command)
        {
            ...
            {
                Log(
                    $"[MatchZyDemoUploadURL] Invalid URL: {url}. Please provide a valid URL for uploading the demo!"
                );
                return;
            }
            demoUploadURL = url;
        ...
        )
        {
            ...
            else
            {
                ...
                ReplyToUserCommand(
                    player,
                    Localizer["matchzy.cc.usage", $"matchzy_max_saved_last_grenades <number>"]
                );
            }
        }
        ...
        public void MatchZyBackupUploadURL(CCSPlayerController? player, CommandInfo command)
        {
            ...
            {
                Log(
                    $"[MatchZyBackupUploadURL] Invalid URL: {url}. Please provide a valid URL for uploading the backup!"
                );
                return;
            }
            backupUploadURL = url;
